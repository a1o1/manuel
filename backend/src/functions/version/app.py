...
from api_versioning import get_versioning_handler, ApiVersion
...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.info("Version API request", 
                   path=path, 
                   method=method, 
        ...
        if path.endswith('/version/compatibility'):
            return handle_compatibility_info(requested_version, versioning_handler, logger)
...
def create_versioned_response(data: Dict[str, Any], version: ApiVersion, handler) -> Dict[str, Any]:
...
def create_versioned_error_response(error: str, status_code: int, version: ApiVersion) -> Dict[str, Any]:
