...
def lambda_handler(event, context):
    ...
    try:
        ...
        index_name = event["ResourceProperties"].get(
            "IndexName", "bedrock-kb-default-index"
        )
        ...
        opensearch_client = boto3.client(
            "opensearch", region_name=os.environ["AWS_REGION"]
        )
        ...
        index_body = {
            ...
            "mappings": {
                "properties": {
                    ...
                    "bedrock-knowledge-base-text-field": {"type": "text"},
                    "bedrock-knowledge-base-metadata-field": {"type": "text"},
                }
            },
        }
        ...
        urllib_request = urllib.request.Request(
            url, data=data.encode("utf-8"), headers=dict(request.headers), method="PUT"
        )
