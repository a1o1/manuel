...
def handle_upload_manual(event: Dict[str, Any], user_id: str) -> Dict[str, Any]:
    ...
    is_valid, body = validate_json_body(event, ['file_name', 'file_data', 'content_type'])
    if not is_valid:
...
def upload_manual_to_s3(file_name: str, file_data: str, content_type: str, user_id: str) -> str:
